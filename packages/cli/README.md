...
running command...
$ ankimd (--version)
@anki.md/cli/0.2.0 linux-x64 node-v18.10.0
$ ankimd --help [COMMAND]
USAGE
  $ ankimd COMMAND
...
...
_See code: [dist/commands/sync.ts](https://github.com/timgreen/Anki.md/blob/@anki.md/cli@0.2.0/packages/cli/src/commands/sync.ts)_
