...
running command...
$ ankimd (--version)
@anki.md/cli/0.3.1 linux-x64 node-v18.12.1
$ ankimd --help [COMMAND]
USAGE
  $ ankimd COMMAND
...
...
_See code: [dist/commands/sync.ts](https://github.com/timgreen/Anki.md/blob/@anki.md/cli@0.3.1/packages/cli/src/commands/sync.ts)_
