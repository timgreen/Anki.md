// Copied from https://github.com/colebemis/lumen/blob/main/src/remark-plugins/tag-link.ts
// Import it instead once the public package is avaiable.
// https://github.com/colebemis/lumen/issues/27
...
export interface TagLink extends Node {
  type: "tagLink";
  data: { name: string };
}
